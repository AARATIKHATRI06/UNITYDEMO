  ...
  return (
    ...
    >
      ...
      <div className="text-[#ebedef] pl-[1200px] relative flex-shrink-0 ">
        <Image
          src={home5}
          className="h-[900] w-[900] animate__animated animate__fadeInUp animate__delay-1s motion-safe:animate__duration-1s"
        />
        <Image
          src={home7}
          className="h-[400] w-[400] absolute left-0 bottom-0 animate__animated animate__fadeInUp animate__delay-1s motion-safe:animate__duration-1s"
        />
      </div>
      ...
      <div className="flex items-center">
        <div className="pl-40 justify-end" style={{ paddingTop: "100px" }}>
          <Image
            src={chatting}
            className=" animate__animated animate__fadeInLeft animate__delay-1s motion-safe:animate__duration-1s"
      ...
      <div className="flex items-center bg-black">
        ...
        <div className="pl-40 justify-end" style={{ paddingTop: "100px" }}>
          <Image
            src={vconnected}
            className=" animate__animated animate__fadeInRight animate__delay-1s motion-safe:animate__duration-1s"
            style={{ height: "650px", width: "650px" }}
          />
        </div>
      </div>
      ...
      <div className=" pt-0  bg-black">
        <div
          className="selection:text-blue-300 text-5xl font-bold text-[white] pb-4 animate__animated animate__fadeInUp"
          style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)" }}
        >
          RELIABLE TECH FOR STAYING CLOSE
        </div>
        <p className="text-2xl text-[white] pr-[20px] selection:text-blue-300 pb-6 animate__animated animate__fadeInUp motion-safe:animate__duration-1s">
